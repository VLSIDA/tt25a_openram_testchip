...
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/47-odb-reportdisconnectedpins/tt_um_openram_top.odb
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.def
set ::env(SAVE_SDC) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.sdc
set ::env(SAVE_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.pnl.v
