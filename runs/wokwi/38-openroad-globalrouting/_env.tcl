...
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/36-openroad-resizertimingpostcts/tt_um_openram_top.odb
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/38-openroad-globalrouting/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/38-openroad-globalrouting/tt_um_openram_top.def
