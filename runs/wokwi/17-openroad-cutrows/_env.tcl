...
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/16-odb-manualmacroplacement/tt_um_openram_top.odb
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/17-openroad-cutrows/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/17-openroad-cutrows/tt_um_openram_top.def
