set ::env(TRACKS_INFO_FILE_PROCESSED) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/config.tracks
...
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/tt_um_openram_top.def
set ::env(SAVE_SDC) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/tt_um_openram_top.sdc
set ::env(SAVE_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/tt_um_openram_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/13-openroad-floorplan/tt_um_openram_top.pnl.v
