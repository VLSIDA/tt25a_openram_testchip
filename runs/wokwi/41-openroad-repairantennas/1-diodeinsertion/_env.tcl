...
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/38-openroad-globalrouting/tt_um_openram_top.odb
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/41-openroad-repairantennas/1-diodeinsertion/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/41-openroad-repairantennas/1-diodeinsertion/tt_um_openram_top.def
