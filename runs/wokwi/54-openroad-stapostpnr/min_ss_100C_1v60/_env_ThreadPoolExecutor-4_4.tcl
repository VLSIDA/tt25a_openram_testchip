...
set ::env(CURRENT_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/51-openroad-fillinsertion/tt_um_openram_top.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspaces/tt25a_openram_testchip/runs/wokwi/53-openroad-rcx/nom/tt_um_openram_top.nom.spef \"min_*\" /workspaces/tt25a_openram_testchip/runs/wokwi/53-openroad-rcx/min/tt_um_openram_top.min.spef \"max_*\" /workspaces/tt25a_openram_testchip/runs/wokwi/53-openroad-rcx/max/tt_um_openram_top.max.spef"
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/52-odb-cellfrequencytables/tt_um_openram_top.odb
set ::env(SAVE_SDC) /workspaces/tt25a_openram_testchip/runs/wokwi/54-openroad-stapostpnr/tt_um_openram_top.sdc
