...
set ::env(FP_MACRO_HORIZONTAL_HALO) 5
set ::env(FP_MACRO_VERTICAL_HALO) 5
set ::env(CURRENT_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/17-openroad-cutrows/tt_um_openram_top.odb
set ::env(SAVE_ODB) /workspaces/tt25a_openram_testchip/runs/wokwi/18-openroad-tapendcapinsertion/tt_um_openram_top.odb
set ::env(SAVE_DEF) /workspaces/tt25a_openram_testchip/runs/wokwi/18-openroad-tapendcapinsertion/tt_um_openram_top.def
set ::env(SAVE_SDC) /workspaces/tt25a_openram_testchip/runs/wokwi/18-openroad-tapendcapinsertion/tt_um_openram_top.sdc
set ::env(SAVE_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/18-openroad-tapendcapinsertion/tt_um_openram_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspaces/tt25a_openram_testchip/runs/wokwi/18-openroad-tapendcapinsertion/tt_um_openram_top.pnl.v
